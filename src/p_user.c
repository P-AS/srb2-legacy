...
consvar_t cv_cam_dist = CVAR_INIT ("cam_dist", "160", CV_FLOAT|CV_SAVE, NULL, NULL);
consvar_t cv_cam_height = CVAR_INIT ("cam_height", "25", CV_FLOAT|CV_SAVE, NULL, NULL);
...
consvar_t cv_cam_adjust = CVAR_INIT ("cam_adjust", "On", CV_SAVE|CV_SHOWMODIF, CV_OnOff, NULL);
consvar_t cv_cam2_dist = CVAR_INIT ("cam2_dist", "160", CV_FLOAT|CV_SAVE, NULL, NULL);
consvar_t cv_cam2_height = CVAR_INIT ("cam2_height", "25", CV_FLOAT|CV_SAVE, NULL, NULL);
...
consvar_t cv_cam2_adjust = CVAR_INIT ("cam2_adjust", "On", CV_SAVE|CV_SHOWMODIF, CV_OnOff, NULL);

consvar_t cv_viewroll = CVAR_INIT ("viewroll", "Off", CV_SAVE, CV_OnOff, NULL);
consvar_t cv_quakeiiiarena = CVAR_INIT ("earthquake", "On", CV_SAVE, CV_OnOff, NULL);
consvar_t cv_quakeiv = CVAR_INIT ("quakeroll", "Off", CV_SAVE, CV_OnOff, NULL);
consvar_t cv_quakelive = CVAR_INIT ("windowquake", "Off", CV_SAVE, CV_OnOff, NULL);
