...
static struct {
	...
	// Floor shader
	{GLSL_CURVE_VERTEX_SHADER, GLSL_FLOOR_FRAGMENT_SHADER},

	// Wall shader
	{GLSL_CURVE_VERTEX_SHADER, GLSL_WALL_FRAGMENT_SHADER},

	// Sprite shader
	{GLSL_CURVE_VERTEX_SHADER, GLSL_WALL_FRAGMENT_SHADER},

	// Model shader
	{GLSL_CURVE_VERTEX_SHADER, GLSL_MODEL_FRAGMENT_SHADER},

	// Water shader
	{GLSL_CURVE_VERTEX_SHADER, GLSL_WATER_FRAGMENT_SHADER},

	// Fog shader
	{GLSL_CURVE_VERTEX_SHADER, GLSL_FOG_FRAGMENT_SHADER},

	// Sky shader
	{GLSL_CURVE_VERTEX_SHADER, GLSL_SKY_FRAGMENT_SHADER},
